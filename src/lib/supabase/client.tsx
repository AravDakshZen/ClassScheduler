...
// Singleton instance — prevents multiple clients from competing for the Web Lock
// which causes: AbortError: Lock broken by another request with the 'steal' option
let _client: ReturnType<typeof createBrowserClient> | null = null;

// resetClient is intentionally a no-op: destroying the singleton and creating a new
// client causes the new instance to steal the Web Lock from the old one, producing
// "AbortError: Lock broken by another request with the 'steal' option".
// Keeping the same client alive avoids this race condition entirely.
export function resetClient() {
  // no-op — do not nullify _client to prevent Web Lock contention
}
